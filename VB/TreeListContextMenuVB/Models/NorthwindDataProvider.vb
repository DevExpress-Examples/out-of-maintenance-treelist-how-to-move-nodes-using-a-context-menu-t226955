            ...
            Using connection As New OleDbConnection(WebConfigurationManager.ConnectionStrings("Northwind").ConnectionString)
                ...
                Do While reader.Read()
                    employees.Add(New Employee() With {
                        .EmployeeID = DirectCast(reader("EmployeeID"), Integer),
                        .FirstName = DirectCast(reader("FirstName"), String),
                        .LastName = DirectCast(reader("LastName"), String),
                        .HireDate = DirectCast(reader("HireDate"), Date),
                        .ReportsTo = (If(reader("ReportsTo") Is DBNull.Value, Nothing, DirectCast(reader("ReportsTo"), Integer?)))
                    })
                Loop
                reader.Close()
            End Using
