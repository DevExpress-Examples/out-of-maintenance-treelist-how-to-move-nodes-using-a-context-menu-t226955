...
Public Class NorthwindDataProvider
            ...
            Using connection As New OleDbConnection(WebConfigurationManager.ConnectionStrings("Northwind").ConnectionString)
                ...
                Do While reader.Read()
                    employees.Add(New Employee() With { _
                        .EmployeeID = DirectCast(reader("EmployeeID"), Integer), _
                        .FirstName = DirectCast(reader("FirstName"), String), _
                        .LastName = DirectCast(reader("LastName"), String), _
                        .HireDate = DirectCast(reader("HireDate"), Date), _
                        .ReportsTo = (If(reader("ReportsTo") Is DBNull.Value, Nothing, DirectCast(reader("ReportsTo"), Integer?))) _
                    })
                Loop
                reader.Close()
            End Using
    ...
    Private Shared Function IsParent(ByVal parentID As Integer, ByVal childID As Integer) As Boolean
        ...
        Do While employeeID <> 0
            ...
            If employee.EmployeeID = parentID Then
                Return True
            End If
            employeeID = CInt(If(employee.ReportsTo, 0))
        Loop
        Return False
    End Function
    ...
    Public Shared Sub MoveEmployee(ByVal employeeID As Integer, ByVal reportsTo As Integer)
        ...
        If employee.ReportsTo.Equals(reportsTo) OrElse IsParent(employeeID, reportsTo) Then
